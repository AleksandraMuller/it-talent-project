...
const StartPage = () => {
	...
	return (
		<>
			...
			<StyledWrapper>
				<Accordion title='Why do we need a whiteboard?'>
					To share with others the greatest ideas and to make brainstorming
					easier.
				</Accordion>
				<Accordion title='When are the new colors in the whiteboard coming?'>
					Soon! The next release is planned for the end of February.
				</Accordion>
				<Accordion title='Where can I save my stickies?'>
					At the moment you can not save your stickies, but we are working on
